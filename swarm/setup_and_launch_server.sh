...
--device cuda:0 --listen_on 0.0.0.0:* --dht_listen_on ip4/0.0.0.0 \
--initial_peers '/ip4/10.128.0.2/tcp/38505/p2p/QmaydBtD1Wwa742NdRYKreNx9jjXV9ZcAZ8AyzhU2yLppG' 2>&1 | tee -a server_stderr_head_0.log;
