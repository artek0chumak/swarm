...
--expert_pattern head.0.[0:127] --expert_cls lm_head --hidden_dim 512 --num_handlers 64 \
...
--initial_peers "/ip4/10.128.0.2/tcp/46015/p2p/QmcvLHH6ZSDBNmbZs3rLPvcWKhz45XJQrDMnfpmTTpYMWz" 2>&1 | tee -a server_stderr_head_0.log;
