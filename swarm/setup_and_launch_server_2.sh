...
--expert_pattern body1.0.[0:127] --expert_cls lm_body --hidden_dim 1024 --num_handlers 64 \
...
--initial_peers "/ip4/127.0.0.1/tcp/45485/p2p/QmbKrXmsqbNgRrb6xVUW8Dw1TwTwsjNETV8vixTMQ8MQHc" 2>&1 | tee -a server_stderr_body_1.log;
