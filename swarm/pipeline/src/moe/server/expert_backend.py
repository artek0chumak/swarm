...
import src
from src.moe.server.task_pool import TaskPool
from src.utils.logging import get_logger
from src.utils.nested import nested_compare, nested_flatten, nested_map, nested_pack
from src.utils.tensor_descr import DUMMY_BATCH_SIZE, BatchTensorDescriptor
...
class ExpertBackend:
    ...
    :param expert: nn.Module to be wrapped into a backend. Arbitrary pytorch module with a few limitations:
     ...
     - Using randomness (e.g. Dropout) leads to different samples at forward and backward. If you want consistency,
        ...
        See src.utils.custom_layers.DeterministicDropout for an example
    ...
    def apply_gradients(self, batch_size) -> None:
        ...
        if isinstance(self.optimizer, src.CollaborativeOptimizer):
